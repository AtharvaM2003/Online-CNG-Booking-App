    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pumps.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                temparea = position;
                if (temparea == 1) {
                    upiid.setText("UPI ID - alecnggas@ybl");
                    upino.setText("UPI Details");
                }
                if (temparea == 2) {
                    upiid.setText("UPI ID - narayangaoncnggas@ybl");
                    upino.setText("UPI Details");
                }
            }
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    String mob = dataSnapshot.child(pass).child("Phone Number").getValue(String.class);
                                    SmsManager smsManager = SmsManager.getDefault();
                                    smsManager.sendTextMessage(mob, null, "Dear Customer your slot Booked Successfully ! \n" + "Fees Paid - " + finalprice + " ", null, null);
                                    Intent intent = new Intent(getApplicationContext(), login.class);
                                    startActivity(intent);
